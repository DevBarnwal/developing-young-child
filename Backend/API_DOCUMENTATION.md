...
DELETE /children/:id      // Delete a child (admin only)

// Milestone Management
POST   /milestones        // Create a new milestone entry
GET    /milestones/:id    // Get milestone by ID
GET    /milestones/child/:childId // Get milestones for a child
PUT    /milestones/:id    // Update milestone

// Volunteer Visits
POST   /visits            // Create a new visit record
GET    /visits/:id        // Get visit by ID
GET    /visits/child/:childId // Get visits for a child
GET    /visits/volunteer/:volunteerId // Get visits by volunteer
...
GET    /activities/age/:ageGroup // Get activities by age group
PUT    /activities/:id    // Update activity (admin only)

// Reports & Analytics
GET    /reports/child/:id // Get report for a child
GET    /reports/summary   // Get admin summary report
GET    /reports/volunteer/:volunteerId // Get volunteer performance report
```
